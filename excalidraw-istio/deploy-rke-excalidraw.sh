...
#kubectl apply -f ./config/cert-issuer-nginx-ingress.yaml
...
kubectl apply -f ./config/excalidraw-virtualservice-azure.yaml
kubectl apply -f ../cluster-config/istio-addons-gateway-azure.yaml
kubectl apply -f ./config/excalidraw-peerauthentication.yaml
